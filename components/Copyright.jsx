...
function Copyright() {
	return (
		<>
			...
			<div className='absolute z-10 text-white -mt-9 left-[11.3%] translate-x-[-50%] hover:scale-110 cursor-pointer duration-300'>
				<Image src={myLogo} className='w-10' />
			</div>
			<div className='absolute z-10 text-white -mt-9 left-[7%] translate-x-[-50%]'>
				<p className='text-[#d6d6d6] font-ttHoves'>Designed by</p>
			</div>
			<div className='absolute z-10 text-white -mt-9 left-[50%] translate-x-[-50%]'>
